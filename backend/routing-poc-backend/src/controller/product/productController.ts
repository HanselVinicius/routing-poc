...
import { FindProductService, IFindProductService } from "../../domain/service/findProductService";
...
export class ProductController{
    ...
    public async createProduct(@Body() createProductDto:CreateProductDto,@Res() res: Response){
        const createdProductSku = await this.insertProductService.insertProduct(createProductDto);
